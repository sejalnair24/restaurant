    ...
    const router=useRouter();
     return(
      ...
      <div className="relative z-10 md:-mt-40 -mt-45">
        <h1 className="md:text-6xl text-4xl font-bold font-[marcellus] ">Food Menu</h1>
...
<h2 className="text-4xl font-bold text-amber-300 mb-2 mt-5 ">
    ...
    <div className="md:flex items-center flex flex-row md:justify-between mb-6 md:ml-0 -ml-95">
      <div className="flex items-center md:space-x-4 space-x-2">
        ...
        <div>
          ...
          <h3 className="text-xl font-bold text-black dark:text-white">Fish Chips</h3>
          <p className="text-gray-600 dark:text-gray-100">Atlantic / Chips / Salad / Tartare</p>

          <p className="text-gray-400 text-sm">Free Drinks</p>
        </div>
      </div>
      <div className="flex items-center space-x-4">
        <p className="text-lg font-bold text-yellow-800 md:ml-0 ml-9">$36</p>
        <p className="text-lg font-bold text-yellow-800">$70</p>
      </div>
    </div>
    ...
    <div className="md:flex items-center flex flex-row md:justify-between mb-6 md:ml-0 -ml-95">
      <div className="flex items-center md:space-x-4 space-x-2">
        ...
        <div>
          ...
          <h3 className="text-xl font-bold text-black dark:text-white">Ebony Fillet Steak</h3>
          <p className="text-gray-600 dark:text-gray-100">Truffle mash / pepper sauce</p>

          <p className="text-gray-400 text-sm">Free Drinks</p>
        </div>
      </div>
      <div className="flex items-center space-x-4">
        <p className="text-lg font-bold text-yellow-800  md:ml-0 ml-15">$44</p>
    ...
    <div className="md:flex items-center flex flex-row md:justify-between mb-6 md:ml-0 -ml-95">
      <div className="flex items-center md:space-x-4 space-x-2">
        ...
        <div>
          ...
          <h3 className="text-xl font-bold text-black dark:text-white">Chicken grill</h3>
          <p className="text-gray-600 dark:text-gray-100">Ricotta / goat cheese / beetroot</p>
   ...
   <div className="md:w-1/2 w=full md:px-10 px-5">
    ...
    <div className="flex flex-row  space-x-2 mb-6 md:mx-98 mx-40  md:ml-145 ml-20">
      <div className="border border-gray-400 px-4 py-1 text-black dark:text-white">Half</div>
      <div className="border border-gray-400 px-4 py-1 text-black dark:text-white">Full</div>
    ...
    <div className="md:flex items-center  md:justify-between md:mb-6 ">
      <div className="md:flex items-center md:space-x-4 ">
        <img
          src="https://i.pinimg.com/1200x/04/6f/11/046f1140c8d118c0539c5faadd41a782.jpg" className="w-20 h-20 rounded-full object-cover hidden md:block"
        />
        <div >
     <h3 className="text-xl font-bold text-black md:mt-0 mt-85 dark:text-white">Brownies</h3>
          <p className="text-gray-600 dark:text-gray-100  ">Ricotta / Goat Cheese / Beetroot</p>

          <p className="text-gray-400 text-sm ">Extra Free Drinks</p>
        </div>
      </div>
      <div className="flex items-center space-x-4">
        <p className="text-lg font-bold text-yellow-800 md:mt-0 -mt-17 md:ml-0 ml-63 ">$34</p>
        <p className="text-lg font-bold text-yellow-800 md:mt-0 -mt-17 ">$65</p>
      </div>
    </div>
    ...
    <div className="md:flex items-center justify-between mb-6">
      <div className="flex items-center space-x-4">
        ...
        <div>
          ...
          <h3 className="text-xl font-bold text-black md:mt-0 mt-10 dark:text-white">Cheesecakes</h3>
          <p className="text-gray-600 dark:text-gray-100">Atlantic / Chips / Salad / Tartare</p>
      ...
      <div className="flex items-center space-x-4">
        <p className="text-lg font-bold text-yellow-800 md:ml-0 ml-63 md:mt-0 -mt-21">$55</p>
        <p className="text-lg font-bold text-yellow-800 md:mt-0 -mt-21">$100</p>
      </div>
    </div>
    ...
    <div className="flex items-center justify-between mb-6">
      <div className="flex items-center space-x-4">
        ...
        <div>
          ...
          <h3 className="text-xl font-bold text-black dark:text-white">Muffins</h3>
          <p className="text-gray-600 dark:text-gray-100">Truffle mash / pepper sauce</p>
      ...
      <div className="flex items-center space-x-4">
        <p className="text-lg font-bold text-yellow-800">$66</p>
        <p className="text-lg font-bold text-yellow-800">$120</p>
      </div>
    </div>
    <div className="flex items-center justify-between mb-6">
      <div className="flex items-center space-x-4">
        ...
        <div>
          ...
          <h3 className="text-xl font-bold text-black dark:text-white">Cupcakes</h3>
          <p className="text-gray-600 dark:text-gray-100">Ricotta / goat cheese / beetroot</p>
...
<div className="md:w-1/2 w-full md:px-10 px-5 py-40 ">
   <div className="text-[#7b6749] text-[30px] md:pl-30 pl-10 md:mt-0 -mt-15 font-[lato]">Fresh From Ocean</div>

   <div className="text-black mb-10 text-[44px] md:pl-37 pl-18 dark:text-white font-[marcellus]">Sea Food</div>
    <div className="flex  space-x-2 mb-6 md:mx-145 mx-45">
      <div className="border border-gray-400 px-4 py-1 text-black dark:text-white">Half</div>
      <div className="border border-gray-400 px-4 py-1 text-black dark:text-white">Full</div>
</div>
    ...
    <div className="flex items-center justify-between mb-6">
      <div className="flex items-center space-x-4">
        ...
        <div>
          ...
          <h3 className="text-xl font-bold text-black dark:text-white">Salmon Fry</h3>
          <p className="text-gray-600 dark:text-gray-100">Ricotta / Goat Cheese / Beetroot</p>
    ...
    <div className="flex items-center justify-between mb-6">
      <div className="flex items-center space-x-4">
        ...
        <div>
          ...
          <h3 className="text-xl font-bold text-black dark:text-white">Pangasius or Basa</h3>
          <p className="text-gray-600 dark:text-gray-100">Atlantic / Chips / Salad / Tartare</p>
      ...
      <div className="flex items-center space-x-4">
        <p className="text-lg font-bold text-yellow-800">$15</p>
        <p className="text-lg font-bold text-yellow-800">$30</p>
      </div>
    </div>
    ...
    <div className="flex items-center justify-between mb-6">
      <div className="flex items-center space-x-4">
        ...
        <div>
          ...
          <h3 className="text-xl font-bold text-black dark:text-white">Clams</h3>
          <p className="text-gray-600 dark:text-gray-100">Truffle mash / pepper sauce</p>
      ...
      <div className="flex items-center space-x-4">
        <p className="text-lg font-bold text-yellow-800">$45</p>
        <p className="text-lg font-bold text-yellow-800">$90</p>
      </div>
    </div>
    <div className="flex items-center justify-between mb-6">
      <div className="flex items-center space-x-4">
        ...
        <div>
          ...
          <h3 className="text-xl font-bold text-black dark:text-white">Red Crab</h3>
  ...
  <div className="md:w-1/2 w-full md:px-10 px-5 py-40 ">
   <div className="text-[#7b6749] text-[30px] md:pl-30 pl-10 md:mt-0 -mt-65 font-[lato]">DRINKS & WINE</div>

   <div className="text-black mb-10 text-[44px] md:pl-37 pl-16 dark:text-white font-[marcellus]">Beverage</div>
    <div className="flex  space-x-2 mb-6 md:mx-140 mx-45">
      <div className="border border-gray-400 px-4 py-1 text-black dark:text-white">Half</div>
      <div className="border border-gray-400 px-4 py-1 text-black dark:text-white">Full</div>
 </div>
    ...
    <div className="flex items-center justify-between mb-6">
      <div className="flex items-center space-x-4">
        ...
        <div>
          ...
          <h3 className="text-xl font-bold text-black dark:text-white">Wine</h3>
          <p className="text-gray-600 dark:text-gray-100">Ricotta / Goat Cheese / Beetroot</p>
      ...
      <div className="flex items-center space-x-4">
        <p className="text-lg font-bold text-yellow-800">$34</p>
        <p className="text-lg font-bold text-yellow-800">$65</p>
      </div>
    </div>
    ...
    <div className="flex items-center justify-between mb-6">
      <div className="flex items-center space-x-4">
        ...
        <div>
          ...
          <h3 className="text-xl font-bold text-black dark:text-white">Coffee</h3>
          <p className="text-gray-600 dark:text-gray-100">Atlantic / Chips / Salad / Tartare</p>
    ...
    <div className="flex items-center justify-between mb-6">
      <div className="flex items-center space-x-4">
        ...
        <div>
          ...
          <h3 className="text-xl font-bold text-black dark:text-white">Hot Chocolate</h3>
          <p className="text-gray-600 dark:text-gray-100">Truffle mash / pepper sauce</p>
    ...
    <div className="flex items-center justify-between mb-6">
      <div className="flex items-center space-x-4">
        ...
        <div>
          ...
          <h3 className="text-xl font-bold text-black dark:text-white">Milk Shake</h3>
          <p className="text-gray-600 dark:text-gray-100">Ricotta / goat cheese / beetroot</p>
  ...
  <div className="bg-gray-200 md:py-20 py-10 md:mt-0 -mt-18 dark:bg-zinc-800">
    <div className="text-[#82704e] text-2xl font-bold text-center dark:text-amber-100 font-[lato] ">HAPPY CUSTOMERS</div>
  <div className="text-black text-4xl font-bold text-center mt-5 dark:text-white font-[marcellus]">Our Customers Feedback</div>
...
<div className="text-black text-3xl font-bold md:mx-20 mx-18 dark:text-white font-[marcellus]">Best Food Ever</div>
...
<div className="text-black md:text-3xl text-2xl  mx-20 font-bold mt-10 dark:text-white font-[marcellus]">Matthew J. Wyman</div>



<div className="text-[#82704e] md:text-2xl  md:mx-20 mx-25 mt-3 font-bold font-[lato]">SENIOR CONSULTANT</div>
    </div>
  </div>
  </div>
