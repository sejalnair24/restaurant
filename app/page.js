...
<div className="md:flex flex-row flex-col">
 ...
 <div className="flex flex-row">
   ...
   <div className="md:flex flex-row flex-col md:mt-0 -mt-150 md:gap-[150px] ">
      <div className=" md:ml-60 ml-5 bg-white shadow-lg  md:w-[450px] w-full h-[200px] md:px-4 py-5 flex flex-col ">
    <h6 className="text-gray-800 py-3">By Md SohagBurger ,Food</h6>
      <h3 className="md:text-3xl text-2xl font-bold text-gray-800 font-[marcellus]  ">
