  ...
  const [password, setPassword] = useState("");
    ...
    return(
                  ...
                  <div className="relative z-10 -mt-40">
                    <h1 className="md:text-6xl text-4xl font-bold font-[marcellus] ">Register Page</h1>
                    <p className="text-lg mt-5 font-semibold">
                      Home <span className="text-gray-300"></span> register
                    </p>
                  </div>
                </div>
                </div>   </div>
                <div className="md:flex flex-row flex-col bg-white dark:bg-black md:h-180  md:mt-10 -mt-40 md:ml-20">
                   ...
                   <div className="md:-ml-77 ml-11"> <h6 className="text-gray-700 dark:text-gray-500 md:mt-38 mt-5  font-[lato]">Enter your details to create a new account</h6></div>
                    <div className="flex flex-col md:-ml-73 ml-10">
                        <input className="md:w-90 w-70 h-13  bg-gray-300 text-black rounded-[5px] md:mt-50 mt-5 px-7 md:p-3 "type="email"placeholder="Email*" onChange={(e) => setEmail(e.target.value)}
                        />
                         <input className="md:w-90 w-70 h-13 bg-gray-300 text-black rounded-[5px]  mt-5 items-center justify-center px-7 md:p-3" type="password"placeholder="password"onChange={(e)=>setPassword(e.target.value)}
                       />
                         <input className="md:w-90 w-70 h-13 bg-gray-300 text-black rounded-[5px] mt-5 px-7 md:p-3 "type="password"placeholder="confirm password" 
                        />
                        <button className="md:w-90 w-40 md:-ml-0 h-13 bg-gray-800 rounded-[5px] mt-5 text-white  justify-center items-center md:mx-20  hover:bg-[#7b4c2b]"onClick={async(event)=>{
                  ...
                  <div className="flex flex-row">
                   <button className="md:w-42 md:-ml-0 w-40 h-13 bg-gray-800 rounded-[5px] mt-5 text-white  justify-center items-center md:mx-20   hover:bg-[#7b4c2b]"onClick={async(event)=>{
                      ...
                      <button className="md:w-42 w-50 md:-ml-15 h-13 bg-gray-800 rounded-[5px] mt-5  text-white justify-center items-center md:mx-20 hover:bg-[#7b4c2b]"onClick={async(event)=>{
